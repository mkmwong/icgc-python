# -*- coding: utf-8 -*-
#
# icgc documentation build configuration file, created by
...
project = u'icgc'
copyright = u'2017, The Ontario Institute For Cancer Research'
...
latex_documents = [
    (master_doc, 'icgc.tex', u'icgc Documentation',
